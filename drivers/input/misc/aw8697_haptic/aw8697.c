...
static char aw8697_rtp_thirteen_name[][AW8697_RTP_NAME_MAX] = {
	...
	{"aw8697_rtp_1.bin"},
	{"aw8697_rtp_1.bin"},
	{"21_AcousticGuitar_RTP.bin"}, //21
	{"Blues_RTP.bin"}, //22 (empty)
	{"23_Candy_P_RTP.bin"},
	{"24_Carousel_P_RTP.bin"},
	{"25_Celesta_P_RTP.bin"},
	{"26_Childhood_P_RTP.bin"},
	{"27_Country_P_RTP.bin"},
	{"28_Cowboy_P_RTP.bin"},
	{"Echo_RTP.bin"}, //29 (empty)
    {"30_Fairyland_P_RTP.bin"},
    {"31_Fantasy_P_RTP.bin"},
    {"32_FieldTrip_P_RTP.bin"},
    {"33_Glee_P_RTP.bin"},
	{"Glockenspiel_RTP.bin"},
    {"35_IceLatte_P_RTP.bin"},
    {"36_KungFu_P_RTP.bin"},
	{"Leisure_RTP.bin"}, //37 (empty)
    {"38_Lollipop_P_RTP.bin"},
    {"39_MiMix2_P_RTP.bin"},
    {"40_Mi_P_RTP.bin"},
    {"41_MiHouse_P_RTP.bin"},
    {"42_MiJazz_P_RTP.bin"},
    {"43_MiRemix_P_RTP.bin"},
    {"44_MountainSpring_P_RTP.bin"},
    {"45_Orange_P_RTP.bin"},
    {"46_WindChime_P_RTP.bin"},
    {"47_SpaceAge_P_RTP.bin"},
    {"48_ToyRobot_P_RTP.bin"},
    {"49_Vigor_P_RTP.bin"},
    {"50_Bottle_P_RTP.bin"},
    {"51_Bubble_P_RTP.bin"},
    {"52_Bullfrog_P_RTP.bin"},
    {"53_Burst_P_RTP.bin"},
    {"54_Chirp_P_RTP.bin"},
    {"55_Clank_P_RTP.bin"},
    {"56_Crystal_P_RTP.bin"},
    {"57_FadeIn_P_RTP.bin"},
    {"58_FadeOut_P_RTP.bin"},
    {"59_Flute_P_RTP.bin"},
    {"60_Fresh_P_RTP.bin"},
    {"61_Frog_P_RTP.bin"},
    {"62_Guitar_P_RTP.bin"},
    {"63_Harp_P_RTP.bin"},
    {"64_IncomingMessage_P_RTP.bin"},
    {"65_MessageSent_P_RTP.bin"},
    {"66_Moment_P_RTP.bin"},
    {"67_NotificationXylophone_P_RTP.bin"},
    {"68_Potion_P_RTP.bin"},
    {"69_Radar_P_RTP.bin"},
    {"70_Spring_P_RTP.bin"},
	{"71_Swoosh_P_RTP.bin"},
	...
	{"taskcard_remove_rtp.bin"}, //89 (empty)
    {"90_taskCleanAll_P_RTP.bin"},
    {"91_newIconFolder_P_RTP.bin"},
    {"92_notificationRemove_P_RTP.bin"},
    {"93_notificationCleanall_P_RTP.bin"},
	{"notification_setting_rtp.bin"}, //94 (empty)
	{"game_turbo_rtp.bin"}, //95 (empty)
    {"96_nfcCard_P_RTP.bin"},
	{"wakeup_voice_assistant_rtp.bin"}, //97 (empty)
    {"98_nfcCardSlow_P_RTP.bin"},
	{"aw8697_rtp_1.bin"}, //99 (placeholder)
	{"aw8697_rtp_1.bin"}, //100 (placeholder)
    {"101_offlineCountdown_P_RTP.bin"},
	{"scene_bomb_injury_RTP.bin"}, //102 (empty)
    {"103_sceneBomb_P_RTP.bin"},
    {"104_doorOpen_P_RTP.bin"},
	{"aw8697_rtp_1.bin"}, //105 (placeholder)
    {"106_sceneStep_P_RTP.bin"},
    {"107_crawl_P_RTP.bin"},
    {"108_scopeOn_P_RTP.bin"},
    {"109_scopeOff_P_RTP.bin"},
    {"110_magazineQuick_P_RTP.bin"},
    {"111_grenade_P_RTP.bin"},
    {"112_sceneGetshot_P_RTP.bin"},
    {"113_grenadeExplosion_P_RTP.bin"},
    {"114_punch_P_RTP.bin"},
    {"115_pan_P_RTP.bin"},
    {"116_bandage_P_RTP.bin"},
	{"aw8697_rtp_1.bin"}, //117 (placeholder)
    {"118_sceneJump_P_RTP.bin"},
    {"119_vehiclePlane_P_RTP.bin"},
    {"120_sceneOpenparachute_P_RTP.bin"},
    {"121_sceneCloseparachute_P_RTP.bin"},
    {"122_vehicleCollision_P_RTP.bin"},
    {"123_vehicleBuggy_P_RTP.bin"},
    {"124_vehicleDacia_P_RTP.bin"},
    {"125_vehicleMoto_P_RTP.bin"},
    {"126_firearmsAkm_P_RTP.bin"},
    {"127_firearmsM16a4_P_RTP.bin"},
	{"aw8697_rtp_1.bin"}, //128 (placeholder)
    {"129_firearmsAwm_P_RTP.bin"},
    {"130_firearmsMini14_P_RTP.bin"},
    {"131_firearmsVss_P_RTP.bin"},
    {"132_firearmsQbz_P_RTP.bin"},
    {"133_firearmsUmp9_P_RTP.bin"},
    {"134_firearmsDp28_P_RTP.bin"},
    {"135_firearmsS1897_P_RTP.bin"},
	{"aw8697_rtp_1.bin"}, //136 (placeholder)
    {"137_firearmsP18c_P_RTP.bin"},
	{"aw8697_rtp_1.bin"}, //138 (placeholder)
	{"aw8697_rtp_1.bin"}, //139 (placeholder)
    {"140_cfmKillOne_P_RTP.bin"},
    {"141_cfmHeadshot_P_RTP.bin"},
    {"142_cfmMultiKill_P_RTP.bin"},
    {"143_cfmKillOneStrong_P_RTP.bin"},
    {"144_cfmHeadshotStrong_P_RTP.bin"},
    {"145_cfmMultiKillStrong_P_RTP.bin"},
    {"146_cfmWeaponGrenadeExplode_P_RTP.bin"},
    {"147_cfmWeaponGrenadeKillOne_P_RTP.bin"},
    {"148_cfmImpactFleshNormal_P_RTP.bin"},
    {"149_cfmWeaponC4Installed_P_RTP.bin"},
    {"150_cfmHeroAppear_P_RTP.bin"},
    {"151_cfmUIRewardOpenBox_P_RTP.bin"},
    {"152_cfmUIRewardTask_P_RTP.bin"},
    {"153_cfmWeaponBLTShoot_P_RTP.bin"},
    {"154_Atlantis_P_RTP.bin"},
    {"155_DigitalUniverse_P_RTP.bin"},
    {"156_Reveries_P_RTP.bin"},
    ...
    {"173_signalButtonHighlight_P_RTP.bin"},
    {"174_signalButtonNegative_P_RTP.bin"},
    {"175_signalButton_P_RTP.bin"},
    {"176_signalClockHigh_P_RTP.bin"},
    {"177_signalClock_P_RTP.bin"},
    {"178_signalClockUnit_P_RTP.bin"},
    {"179_signalInputbox_P_RTP.bin"},
    {"180_signalKeyHigh_P_RTP.bin"},
    {"181_signalKeyUnit_P_RTP.bin"},
    {"182_signalListHighlight_P_RTP.bin"},
    {"183_signalList_P_RTP.bin"},
    {"184_signalPicker_P_RTP.bin"},
    {"185_signalPopup_P_RTP.bin"},
    {"186_signalSeekbar_P_RTP.bin"},
    {"187_signalSwitch_P_RTP.bin"},
    {"188_signalTab_P_RTP.bin"},
    {"189_signalText_P_RTP.bin"},
    {"190_signalTransitionLight_P_RTP.bin"},
    {"191_signalTransition_P_RTP.bin"},
...
RTP_REQUEST_NORMAL:
			...
			ret = request_firmware(&rtp_file,
					       aw8697_rtp_name[aw8697->rtp_file_num],
					       aw8697->dev);
			/* try load MIUI 13 firmware */
			if (ret < 0) {
				ret = request_firmware(&rtp_file,
							aw8697_rtp_thirteen_name[aw8697->rtp_file_num],
							aw8697->dev);
			}
			if (ret < 0) {
				pr_err("%s: failed to read %s\n", __func__,
...
#if defined(SUPPORT_BLACKSHARK_RTP)
RTP_REQUEST_DONE:
#endif
			vfree(aw8697_rtp);
			aw8697_rtp = vmalloc(rtp_file->size + sizeof(int));
